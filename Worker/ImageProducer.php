...
class ImageProducer
{
    ...
    const FONT_SIZE = 10;
    const MARGIN_WIDTH = 3;//25;
    const MARGIN_HEIGHT = 2;//15;
    const PIC_WIDTH = 140.4;//191;
    const PIC_HEIGHT = 172.8;//233;
    const BIG_CANVAS_WIDTH = 294;//480;
    const BIG_CANVAS_HEIGHT = 455;//672;
    ...
    public function writeLineText(int $line, string $text)
    {
        ...
        $offsetY = self::PIC_HEIGHT + self::MARGIN_HEIGHT + 13 + $line * $this->fontY;
